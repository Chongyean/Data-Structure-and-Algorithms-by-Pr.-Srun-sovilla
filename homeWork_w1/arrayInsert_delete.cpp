...
void deleteElement()
{
    ...
    for (int i = position; i < 9; i++) // 9 is size arr
    {
        arr[i] = arr[i + 1]; // shift the elements to left
    }

    arr[10 - 1] = 0; // remove last element
...
void deleteAllElements() {
    ...
    {
        arr[i] = 0; // remove the rest of the elements
    }
...
void ui ()
{
    ...
    {
        cout << "============================================="<< endl;
        cout << "1. Show elements of arr" << endl;
